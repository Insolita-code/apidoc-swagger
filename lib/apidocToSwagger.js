...
function toSwagger(apidocJson, projectJson, bracketFormat) {
	swagger.info = addInfo(projectJson);
	swagger.paths = extractPaths(apidocJson, bracketFormat);
	return swagger;
}
 ...
 * @returns {{}}
 */
function extractPaths(apidocJson, bracketFormat = false){
